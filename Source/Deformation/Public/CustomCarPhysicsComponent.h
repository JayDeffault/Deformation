...
public:
    ...
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="Debug") int32 MaxDebugCollisionTriangles = 256;
...
private:
    ...
    // Authoritative low-poly deformable collision mesh: vertices + plane cache are updated without Chaos recook.
    FCustomConvexMesh PhysicsMesh;
    // High-poly render mesh deformed by the same impact events and updated through ProceduralMeshComponent.
    FCustomConvexMesh VisualMeshState;
